...
def _default_config():
    return {
        ...
        "sources": {
            "azure_blob_storage": "connectors_service.sources.azure_blob_storage:AzureBlobStorageDataSource",
            "box": "connectors_service.sources.box:BoxDataSource",
            "confluence": "connectors_service.sources.confluence:ConfluenceDataSource",
            "dir": "connectors_service.sources.directory:DirectoryDataSource",
            "dropbox": "connectors_service.sources.dropbox:DropboxDataSource",
            "github": "connectors_service.sources.github:GitHubDataSource",
            "gmail": "connectors_service.sources.gmail:GMailDataSource",
            "google_cloud_storage": "connectors_service.sources.google_cloud_storage:GoogleCloudStorageDataSource",
            "google_drive": "connectors_service.sources.google_drive:GoogleDriveDataSource",
            "graphql": "connectors_service.sources.graphql:GraphQLDataSource",
            "jira": "connectors_service.sources.jira:JiraDataSource",
            "microsoft_teams": "connectors_service.sources.microsoft_teams:MicrosoftTeamsDataSource",
            "mongodb": "connectors_service.sources.mongo:MongoDataSource",
            "mssql": "connectors_service.sources.mssql:MSSQLDataSource",
            "mysql": "connectors_service.sources.mysql:MySqlDataSource",
            "network_drive": "connectors_service.sources.network_drive:NASDataSource",
            "notion": "connectors_service.sources.notion:NotionDataSource",
            "onedrive": "connectors_service.sources.onedrive:OneDriveDataSource",
            "oracle": "connectors_service.sources.oracle:OracleDataSource",
            "outlook": "connectors_service.sources.outlook:OutlookDataSource",
            "postgresql": "connectors_service.sources.postgresql:PostgreSQLDataSource",
            "redis": "connectors_service.sources.redis:RedisDataSource",
            "s3": "connectors_service.sources.s3:S3DataSource",
            "salesforce": "connectors_service.sources.salesforce:SalesforceDataSource",
            "sandfly": "connectors_service.sources.sandfly:SandflyDataSource",
            "servicenow": "connectors_service.sources.servicenow:ServiceNowDataSource",
            "sharepoint_online": "connectors_service.sources.sharepoint_online:SharepointOnlineDataSource",
            "sharepoint_server": "connectors_service.sources.sharepoint_server:SharepointServerDataSource",
            "slack": "connectors_service.sources.slack:SlackDataSource",
            "zoom": "connectors_service.sources.zoom:ZoomDataSource",
        },
    }
