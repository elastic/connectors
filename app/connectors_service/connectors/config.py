...
def _default_config():
    return {
        ...
        "sources": {
            ...
            "dir": "connectors.sources.directory.datasource:DirectoryDataSource",
            "dropbox": "connectors.sources.dropbox.datasource:DropboxDataSource",
            "github": "connectors.sources.github:GitHubDataSource",
            "gmail": "connectors.sources.gmail.datasource:GMailDataSource",
            "google_cloud_storage": "connectors.sources.google_cloud_storage.datasource:GoogleCloudStorageDataSource",
            "google_drive": "connectors.sources.google_drive.datasource:GoogleDriveDataSource",
            ...
            "network_drive": "connectors.sources.network_drive.datasource:NASDataSource",
