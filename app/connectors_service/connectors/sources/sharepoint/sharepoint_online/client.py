...
# Shared Microsoft Graph / Entra building blocks. Re-exported below so that
# existing imports from this module keep working.
from connectors.sources.shared.microsoft.graph import (  # noqa: F401
    BadRequestError,
    EntraAPIToken,
    GraphAPIToken,
    InternalServerError,
