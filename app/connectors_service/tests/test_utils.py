...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            # Every 5 minutes - Quartz "start/step" syntax (e.g. set via the API)
            "0 0/5 * * * ?",
            datetime(2023, 1, 18, 17, 18, 56, 814, tzinfo=timezone.utc),
            datetime(2023, 1, 18, 17, 20, 0, tzinfo=timezone.utc),
        ),
        (
            # Every 15 minutes - Quartz "start/step" syntax
            "0 0/15 * * * ?",
            datetime(2023, 1, 18, 17, 18, 56, 814, tzinfo=timezone.utc),
            datetime(2023, 1, 18, 17, 30, 0, tzinfo=timezone.utc),
        ),
        (
            # Every 30 minutes - Quartz "start/step" syntax
            "0 0/30 * * * ?",
            datetime(2023, 1, 18, 17, 18, 56, 814, tzinfo=timezone.utc),
            datetime(2023, 1, 18, 17, 30, 0, tzinfo=timezone.utc),
        ),
        (
            # Every 3 hours - Quartz "start/step" syntax; the case from issue #3935
            "0 0 0/3 * * ?",
            datetime(2023, 1, 18, 17, 18, 56, 814, tzinfo=timezone.utc),
            datetime(2023, 1, 18, 18, 0, 0, tzinfo=timezone.utc),
        ),
        (
            # Every 3 hours - Quartz "start/step" syntax; without overflow
            "0 0 0/3 * * ?",
            datetime(2023, 1, 18, 11, 59, 56, 814, tzinfo=timezone.utc),
            datetime(2023, 1, 18, 12, 0, 0, tzinfo=timezone.utc),
        ),
        (
            # Every 2 hours with a non-zero start offset - Quartz "start/step" syntax
            "0 0 1/2 * * ?",
            datetime(2023, 1, 18, 17, 18, 56, 814, tzinfo=timezone.utc),
            datetime(2023, 1, 18, 19, 0, 0, tzinfo=timezone.utc),
        ),
        (
            # Every 6 hours restricted to a range - Quartz "low-high/step" syntax
            "0 0 0-12/6 * * ?",
            datetime(2023, 1, 18, 17, 18, 56, 814, tzinfo=timezone.utc),
            datetime(2023, 1, 19, 0, 0, 0, tzinfo=timezone.utc),
        ),
        (
            # Every 2 days of the month - Quartz "start/step" syntax
            "0 0 0 1/2 * ?",
            datetime(2023, 1, 18, 17, 18, 56, 814, tzinfo=timezone.utc),
            datetime(2023, 1, 19, 0, 0, 0, tzinfo=timezone.utc),
        ),
