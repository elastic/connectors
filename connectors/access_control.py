...
def prefix_identity(prefix: Optional[str], identity: Optional[Union[int, str]]) -> Optional[str]:
...
def es_access_control_query(access_control: List[Optional[str]]) -> Dict[str, Dict[str, Dict[str, Union[Dict[str, List[str]], str]]]]:
