...
class SyncRuleValidationResult:
    ...
    def __init__(self, rule_id, is_valid, validation_message) -> None:
        self.rule_id = rule_id
        self.is_valid = is_valid
        self.validation_message = validation_message

    @classmethod
    def valid_result(cls, rule_id) -> "SyncRuleValidationResult":
...
class FilterValidationError:
    ...
    def __init__(self, ids=None, messages=None) -> None:
        if ids is None:
            ids = []
        if messages is None:
            messages = []
...
class FilteringValidationState(Enum):
    ...
    @classmethod
    def to_s(cls, value) -> Optional[str]:
        match value:
...
class FilteringValidationResult:
    ...
    def __add__(self, other) -> "FilteringValidationResult":
        if other is None:
            return self
...
class FilteringValidator:
    ...
    async def validate(self, filtering) -> FilteringValidationResult:
...
class BasicRulesSetSemanticValidator(BasicRulesSetValidator):
    ...
    @classmethod
    def validate(cls, rules) -> List[SyncRuleValidationResult]:
        rules_dict = {}
...
class BasicRuleNoMatchAllRegexValidator(BasicRuleValidator):
    ...
    @classmethod
    def validate(cls, basic_rule_json) -> SyncRuleValidationResult:
...
class BasicRuleAgainstSchemaValidator(BasicRuleValidator):
    ...
    @classmethod
    def validate(cls, rule) -> SyncRuleValidationResult:
        try:
