...
URLS = {
    ...
    ATTACHMENT: "{value}/_api/web/GetFileByServerRelativePath(decodedUrl='{file_relative_url}')/$value",
    ...
    ATTACHMENT_DATA: "{parent_site_url}/_api/web/getfilebyserverrelativepath(decodedUrl='{file_relative_url}')",
