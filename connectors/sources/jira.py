...
class JiraDataSource(BaseDataSource):
    ...
    def _decorate_with_access_control(self, document: Dict[str, Union[str, Dict[str, Union[Dict[str, str], str, List[Dict[str, Union[str, int]]], Dict[str, Dict[Any, Any]]]], Dict[str, str], Dict[str, Union[Dict[str, str], str, List[Dict[str, Union[str, int]]], Dict[str, Dict[str, List[Dict[str, str]]]]]], int]], access_control: Union[str, List[str]]) -> Dict[str, Any]:
    ...
    async def get_content(self, issue_key: str, attachment: Dict[str, Union[str, int]], timestamp: None=None, doit: bool=False) -> Generator[Future, None, Optional[Dict[str, str]]]:
