...
class SlackClient:
    def __init__(self, configuration: Union[DataSourceConfiguration, Dict[str, Union[str, int, bool]]]) -> None:
    ...
    async def ping(self) -> Generator[Task, None, bool]:
    ...
    def _get_next_cursor(self, response: Dict[str, Union[bool, List[Dict[str, Union[str, bool]]], Dict[str, str], List[Dict[str, str]], List[Union[Dict[str, Union[int, str]], Dict[str, str]]]]]) -> Optional[str]:
...
class SlackDataSource(BaseDataSource):
    ...
    def remap_user(self, user: Dict[str, str]) -> Dict[str, Optional[str]]:
        user_profile = user.get("profile", {})
        return {
            "_id": user["id"],
            "type": "user",
    ...
    def remap_channel(self, channel: Dict[str, Union[str, bool]]) -> Dict[str, Optional[str]]:
    ...
    def remap_message(self, message: Dict[str, Union[int, str]], channel: Dict[str, Union[str, int, bool]]) -> Dict[str, Optional[Union[int, str]]]:
