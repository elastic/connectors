...
class SandflyAccessToken:
    def __init__(self, http_session: ClientSession, configuration: Union[Dict[str, Union[str, int, bool]], DataSourceConfiguration], logger_: ExtraLogger) -> None:
...
class SandflySession:
    ...
    async def content_post(self, url: str, payload: Dict[str, Union[int, str, List[Dict[str, str]], Dict[str, Union[str, List[Dict[str, str]]]], Dict[str, List[Dict[str, str]]]]]) -> Generator[Task, None, str]:
        try:
...
class SandflyClient:
    def __init__(self, configuration: Union[Dict[str, Union[str, int, bool]], DataSourceConfiguration]) -> None:
        self._sleeps = CancellableSleeps()
        self._logger = logger
...
class SandflyDataSource(BaseDataSource):
    ...
    def _format_doc(self, doc_id: str, doc_time: str, doc_text: str, doc_field: str, doc_data: Dict[str, Optional[Union[str, Dict[str, Dict[str, Dict[str, str]]], Dict[str, str]]]]) -> Dict[str, Union[str, Dict[str, Union[str, Dict[str, Dict[str, Dict[str, str]]]]], Dict[str, Optional[str]], Dict[str, Union[str, Dict[str, str]]], Dict[str, str]]]:
        document = {
            "_id": doc_id,
            "_timestamp": doc_time,
    ...
    def extract_results_data(self, result_item: Dict[str, Union[str, Dict[str, str]]], get_more_results: bool) -> Tuple[str, str, str, str]:
