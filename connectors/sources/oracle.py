...
from connectors.sources.database_utils import CursorSync
...
class OracleClient:
    ...
    async def get_cursor(self, query: str) -> Generator[Future, None, CursorSync]:
...
class OracleDataSource(BaseDataSource):
    ...
    @classmethod
    def get_default_configuration(cls) -> Dict[str, Dict[str, Union[int, str, bool, List[Dict[str, str]], List[str]]]]:
        return {
            "host": {
                "label": "Host",
                "order": 1,
