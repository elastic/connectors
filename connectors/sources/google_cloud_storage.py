...
from typing import Awaitable, Any, Dict, Generator, Iterator, List, Optional, Union
...
class GoogleCloudStorageDataSource(BaseDataSource):
    ...
    async def ping(self) -> Iterator[Union[None, Task, Awaitable]]:
    ...
    def prepare_blob_document(self, blob: Dict[str, str]) -> Dict[str, Optional[str]]:
    ...
    async def get_content(self, blob: Dict[str, Optional[Union[str, int]]], timestamp: None=None, doit: Optional[bool]=None) -> Generator[Union[Future, Awaitable], None, Optional[Dict[str, str]]]:
