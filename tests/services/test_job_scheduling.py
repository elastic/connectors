...
default_next_sync: datetime = datetime.now(timezone.utc) + timedelta(hours=1)
...
@pytest.mark.asyncio
async def test_no_connector(connector_index_mock, sync_job_index_mock, set_env) -> None:
