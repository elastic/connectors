...
async def create_fake_coroutine(data: str) -> str:
...
@pytest.mark.asyncio
async def test_get_content(s3_client: MagicMock) -> Iterator[Future] | None:
...
@mock.patch("aiobotocore.client.AioBaseClient")
@pytest.mark.asyncio
async def test_get_content_with_text_extraction_enabled_adds_body(s3_client: MagicMock) -> Iterator[Future]:
    """Test get_content method of S3Client"""
    with (
        patch(
...
@mock.patch("aiobotocore.client.AioBaseClient")
@pytest.mark.asyncio
async def test_get_content_with_upper_extension(s3_client: MagicMock) -> Iterator[Future] | None:
    """Test get_content method of S3Client"""
...
@pytest.mark.asyncio
async def test_get_content_with_unsupported_file(mock_aws: None) -> None:
...
@pytest.mark.asyncio
async def test_get_content_when_not_doit(mock_aws: None) -> None:
...
@pytest.mark.asyncio
async def test_get_content_when_size_is_large(mock_aws: None) -> None:
...
@pytest.mark.asyncio
async def test_get_docs(mock_aws: None) -> Iterator[None]:
...
@pytest.mark.asyncio
async def test_get_content_with_clienterror() -> Iterator[Future]:
...
@pytest.mark.asyncio
async def test_close_with_client_session() -> Iterator[Future]:
...
@pytest.mark.asyncio
async def test_advanced_rules_validation(advanced_rules: Union[Dict[str, List[str]], List[Dict[str, str]]], expected_validation_result: SyncRuleValidationResult) -> None:
