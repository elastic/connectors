...
class TestSharepointOnlineDataSource:
    ...
    @pytest.mark.asyncio
    @patch("connectors.content_extraction.ContentExtraction._check_configured", lambda *_: True)
    async def test_get_attachment_with_text_extraction_enabled_adds_body(
        ...
        with patch(
            "connectors.content_extraction.ContentExtraction.extract_text", return_value=message
    ...
    @pytest.mark.asyncio
    @patch("connectors.content_extraction.ContentExtraction._check_configured", lambda *_: False)
