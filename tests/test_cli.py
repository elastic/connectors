...
from connectors.old_cli import main, run
...
@patch("connectors.old_cli.set_logger")
@patch("connectors.old_cli.load_config", side_effect=Exception("something went wrong"))
