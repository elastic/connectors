...
class TestESManagementClient:
    ...
    @pytest.mark.asyncio
    async def test_create_content_index(self, es_management_client) -> None:
        index_name = "search-mongo"
        lang_code = "en"
    ...
    @pytest.mark.asyncio
    async def test_delete_indices(self, es_management_client) -> None:
    ...
    @pytest.mark.asyncio
    async def test_index_exists(self, es_management_client) -> None:
        index_name = "search-mongo"
    ...
    @pytest.mark.asyncio
    async def test_clean_index(self, es_management_client) -> None:
        index_name = "search-mongo"
        es_management_client.client.indices.exists = AsyncMock()
    ...
    @pytest.mark.asyncio
    async def test_list_indices(self, es_management_client) -> None:
    ...
    @pytest.mark.asyncio
    async def test_upsert(self, es_management_client) -> None:
        _id = "123"
        index_name = "search-mongo"
