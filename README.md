...
The Connectors SDK is a dependency of the connectors application. You can use the Connectors SDK in and of itself in your own projects should you choose.

> [!NOTE] For those who are familiar with the monolithic project structure that preceded the current structure
