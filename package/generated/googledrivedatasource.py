...
class GoogleDriveDataSource(GoogleDriveDataSource):
    ...
    Args:
        ...
        service_account_credentials (): Google Drive service account JSON
            - This connectors authenticates as a service account to synchronize content from Google Drive.

        use_domain_wide_delegation_for_sync (): Use domain-wide delegation for data sync
        ...
        google_workspace_admin_email_for_data_sync (): Google Workspace admin email
        ...
        google_workspace_email_for_shared_drives_sync (): Google Workspace email for syncing shared drives
        ...
        use_document_level_security (): Enable document level security
        ...
        google_workspace_admin_email (): Google Workspace admin email
        ...
        use_text_extraction_service (): Use text extraction service
